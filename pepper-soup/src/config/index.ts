...
// Path Helpers
export const sourcesDir = (featureId: string) =>
  path.join(PIPELINE_ROOT, "sources", featureId);
export const confluenceSourcesDir = (featureId: string) =>
  path.join(sourcesDir(featureId), "confluence");
export const excelSourcesDir = (featureId: string) =>
  path.join(sourcesDir(featureId), "excel");
...
export const docsDir = (featureId: string) =>
  path.join(PIPELINE_ROOT, "docs", featureId);
