  ...
  return (
    ...
    >
      <div className="relative w-full overflow-hidden">
        <div
          className="flex w-full overflow-x-auto overscroll-x-contain scroll-smooth pb-4 pt-2 scrollbar-none sm:pb-6 md:pb-8"
          ref={carouselRef}
          onScroll={checkScrollability}
        >
          <div className="pointer-events-none absolute inset-y-0 right-0 z-1000 w-10 bg-linear-to-l from-background to-transparent sm:w-14 md:w-20" />
          <div
            className={cn(
              "mx-auto flex max-w-7xl flex-nowrap items-stretch gap-3 px-4 py-2 sm:gap-4 sm:px-6 sm:py-3 lg:gap-6 lg:px-8",
            )}
          >
